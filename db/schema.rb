...
ActiveRecord::Schema.define(version: 2020_04_25_025007) do
  ...
  create_table "used_recipes", force: :cascade do |t|
    t.date "date_used"
    t.bigint "recipe_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["recipe_id"], name: "index_used_recipes_on_recipe_id"
    t.index ["user_id"], name: "index_used_recipes_on_user_id"
  end
  ...
  add_foreign_key "used_recipes", "recipes"
  add_foreign_key "used_recipes", "users"
end
